...
ggplot(data = data.train[1:dim(data.train)[1],],aes(x=FarePerPassengerSegments,fill=Survived))+geom_bar(position="fill")+scale_fill_manual(values=c("#FF0000","#008000"))+ylab("Frecuencia")+labs(title="Supervivencia por dinero por pasajero")
```
...
### Para la resolución realizamos las siguientes acciones y estrajimos las correspondientes conclusiones
